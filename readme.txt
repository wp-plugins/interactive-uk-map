...
**Important! This plugin is outdated. Choose the enhanced responsive [UK Map for WordPress for FREE](https://wordpress.org/plugins/interactive-map-of-the-united-kingdom/) and enjoy cool design, better interactivity and many new capabilities.**
...
Find other UK HTML5 maps and WordPress map plugins at [Fla-shop.com](http://www.fla-shop.com/country/uk/)
...
3. After that, insert the following shortcode into the text of a page or a post where you want the map to be: `[freeukregionmap01]`.
...
Type `[freeukregionmap01]` in the text of a page or a post.

= Can I use two differently configured maps on the same blog? =

No, all maps inserted with the `[freeukregionmap01]` will share the same configuration.
